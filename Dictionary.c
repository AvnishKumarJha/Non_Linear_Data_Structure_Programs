// Demonstrate use of Dictionary and Concept of text Processing.
...
void inorderTraversal(struct BSTnode *myNode)
{
    if (myNode)
    {
        ...
        printf("country : %s", myNode->word);
        printf("capital : %s", myNode->meaning);
        printf("\n");
...
int main()
{
    ...
    while (1)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            printf("Enter the country name to delete: ");
            fgets(str, 100, stdin);
            deleteNode(str);
            break;
        case 3:
            printf("Enter the search country:");
            fgets(str, 100, stdin);
            findElement(str);
            break;
        case 4:
